...
# Practice-problem/week-practice page types ("practice-problems",
# "mcq-practice", "mcq-answers", "coding-practice") are NOT listed here as
# of v0.2.0 — that content is generated by the separate course-manager
# skill, not this one, so this validator no longer recognizes those types
# (see references/course-manager-integration.md).
ALLOWED_TYPES = {"moc", "chapter-summary", "concept", "proof", "case-study", "document-entry", "week", "image-gallery"}
ALLOWED_CALLOUTS = {
